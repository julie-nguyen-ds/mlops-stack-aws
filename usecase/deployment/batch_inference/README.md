# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [usecase/resources/README.md](../../resources/README.md)
...
df.write.mode("overwrite").saveAsTable(
    name="<catalog>.models_uc.feature_store_inference_input"
)
```
