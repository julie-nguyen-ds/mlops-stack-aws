...
[ML Config](../usecase/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore usecase/resources/README.md
...
Follow the instructions in [usecase/resources/README.md](../usecase/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../usecase/resources/README.md)  to propose, test, and deploy
