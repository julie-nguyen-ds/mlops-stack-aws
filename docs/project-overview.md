...
```
mlops_stack_aws        <- Root directory. Both monorepo and polyrepo are supported.
│
├── usecase       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
