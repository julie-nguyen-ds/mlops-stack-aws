...
Opening a pull request will trigger a[workflow](../.github/workflows/usecase-run-tests.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-usecase-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-usecase-model)
